...
from google.adk.tools import exit_loop  # <-- ADDED (Task 5)
...
# ----------------------------
# UPDATED (Task 5 + Task 6): film_concept_team
# ----------------------------
